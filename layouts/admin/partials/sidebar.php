    ...
    <div class="collapse navbar-collapse" id="sidebar-menu">
      ...
      <ul class="navbar-nav pt-lg-3">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle d-flex align-items-center gap-2" href="#navbar-base" data-bs-toggle="dropdown"
            ...
            <span class="nav-link-title"> Coupon </span>
          </a>
          <div class="dropdown-menu">
            <div class="dropdown-menu-columns">
              <div class="dropdown-menu-column">
                <!-- Dashboard Kupon -->
                <a class="dropdown-item" href="admin-crud-kupon.php">
                  <span class="nav-link-title"> Index Coupon </span>
                </a>
                <!-- Validasi Kupon -->
                <a class="dropdown-item" href="validasi-kupon.php">
                  </span>
                  <span class="nav-link-title"> Validasi Kupon </span>
                </a>
        ...
        <!-- Logout -->
        <li class="nav-item">
          <a class="nav-link d-flex align-items-center gap-2" href="../logout-admin.php">
            <span
              class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler.io/icons/icon/home -->
